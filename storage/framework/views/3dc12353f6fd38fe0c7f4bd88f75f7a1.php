        ...
        <div class="flex items-center space-x-3">
            <div class="flex items-center bg-white rounded-xl shadow-sm border border-slate-200 p-1">
                <select wire:model.live="selectedMonth" class="bg-transparent border-none text-sm font-bold text-slate-700 focus:ring-0 cursor-pointer py-1 pl-3 pr-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div wire:click="openReport('ADMINISTRADAS_MES')" class="glass p-8 rounded-3xl border-2 border-emerald-100/50 relative overflow-hidden group cursor-pointer hover:border-emerald-400 transition-all active:scale-95 bg-gradient-to-br from-emerald-50/50 to-white shadow-lg shadow-emerald-100/20">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <div class="text-5xl font-black text-emerald-600 tracking-tighter"><?php echo e(number_format($my_administradas)); ?></div>
            ...
            <div wire:click="openReport('ADMINISTRADAS_MES')" class="glass p-6 rounded-3xl border border-slate-200/50 relative overflow-hidden group cursor-pointer hover:border-emerald-200 transition-all active:scale-95">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div class="text-4xl font-extrabold text-emerald-600 tracking-tighter"><?php echo e(number_format($administradas_mes)); ?></div>
                    </div>
            ...
            <div wire:click="openReport('DESPACHADAS_MES')" class="glass p-6 rounded-3xl border border-slate-200/50 relative overflow-hidden group cursor-pointer hover:border-blue-200 transition-all active:scale-95">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div class="text-4xl font-extrabold text-blue-600 tracking-tighter"><?php echo e(number_format($despachadas_mes)); ?></div>
                    </div>
            ...
            <div wire:click="openReport('PERDIDA_MES')" class="glass p-6 rounded-3xl border border-slate-200/50 relative overflow-hidden group cursor-pointer hover:border-rose-200 transition-all active:scale-95">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div class="text-4xl font-extrabold text-rose-600 tracking-tighter"><?php echo e(number_format($perdida_mes)); ?></div>
                    </div>
                ...
                <div class="mt-2 text-[11px] font-bold text-rose-500">
                    <span class="bg-rose-50 px-2 py-0.5 rounded-lg border border-rose-100"><?php echo e(number_format($porcentaje_perdida, 1)); ?>% TASA ⚠️</span>
                </div>
            </div>
            ...
            <div class="glass p-6 rounded-3xl border border-slate-200/50 relative overflow-hidden group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <div class="text-4xl font-extrabold text-amber-600 tracking-tighter"><?php echo e(number_format($cuarentena_mes)); ?></div>
                    </div>
                    ...
                    <div class="px-8 py-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                        <div>
                            ...
                            <p class="text-sm font-medium text-slate-500 mt-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reportType === 'ADMINISTRADAS_MES'): ?> <span class="text-emerald-600 font-bold">Vacunas Administradas</span>
                                <?php elseif($reportType === 'DESPACHADAS_MES'): ?> <span class="text-blue-600 font-bold">Despachos a Dependencias</span>
                                <?php elseif($reportType === 'PERDIDA_MES'): ?> <span class="text-rose-600 font-bold">Mermas y Pérdidas</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </p>
                        </div>
                        ...
                        <div class="overflow-x-auto rounded-xl border border-slate-200">
                            <table class="w-full text-left">
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->reportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-slate-50">
                                            <td class="px-6 py-3 text-xs font-bold text-slate-600"><?php echo e($row->movement->posted_at ? \Carbon\Carbon::parse($row->movement->posted_at)->format('d/m/Y H:i') : '-'); ?></td>
                                            <td class="px-6 py-3 text-xs font-bold text-slate-900"><?php echo e($row->vaccine->name); ?></td>
                                            <td class="px-6 py-3 text-xs text-slate-500"><?php echo e($row->movement->user->name ?? 'Sistema'); ?></td>
                                            <td class="px-6 py-3 text-sm font-black text-slate-900 text-right"><?php echo e($row->quantity); ?></td>
                                            <td class="px-6 py-3 text-xs text-slate-500 italic"><?php echo e(Str::limit($row->movement->notes, 30)); ?></td>
                                        </tr>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr wire:key="stock-<?php echo e($stock->id); ?>" class="transition-all group border-b border-slate-100 <?php echo e($isCritical ? 'bg-rose-50/60 hover:bg-rose-50' : 'hover:bg-slate-50/80'); ?>">
                            ...
                            <td class="px-8 py-5">
                                <div 
                                    wire:click="$dispatch('openChartModal', { vaccineId: <?php echo e($stock->id); ?>, month: <?php echo e($selectedMonth); ?>, year: <?php echo e($selectedYear); ?> })"
                                    class="text-sm font-bold <?php echo e($stock->status === 'QUARANTINE' ? 'text-amber-700' : 'text-slate-900'); ?> cursor-pointer hover:text-premium-600 transition-colors"
                                >
                                    <?php echo e($stock->name); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stock->status === 'QUARANTINE'): ?>
                                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-bold bg-amber-100 text-amber-700 ml-2">
                                            EN CUARENTENA
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div class="text-[10px] text-slate-400 font-medium uppercase mt-0.5"><?php echo e($stock->manufacturer ?? 'Fabricante N/A'); ?></div>
                            </td>
                            <td class="px-8 py-5 text-right font-black text-slate-900 tabular-nums">
                                <?php echo e(number_format($stock->total_quantity ?? 0)); ?>

                            </td>
                            <td class="px-8 py-5 text-right font-bold text-amber-600 tabular-nums">
                                <?php echo e($stock->quarantine_stock > 0 ? number_format($stock->quarantine_stock) : '-'); ?>
                            ...
                            <td class="px-8 py-5 w-48">
                                <div class="flex items-center space-x-3">
                                        ...
                                        ?>
                                        <div class="h-full <?php echo e($colorClass); ?> transition-all duration-700 shadow-sm" style="width: <?php echo e($visualWidth); ?>%"></div>
                                    </div>
                            ...
                            <td class="px-8 py-5 text-right">
                                        ...
                                        <div class="flex items-center justify-end space-x-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasRole('vacunador')): ?>
                                                ...
                                                <button 
                                                    type="button"
                                                    <?php if($receiptDisabled): echo 'disabled'; endif; ?>
                                                    onclick="<?php echo e($receiptOnclick); ?>"
                                                    class="p-2 <?php echo e($receiptClass); ?> rounded-lg transition-all border border-transparent"
                                                    title="<?php echo e($receiptTitle); ?>"
                                                >
                                            ...
                                            <button 
                                                type="button"
                                                <?php if($consumeDisabled): echo 'disabled'; endif; ?>
                                                onclick="<?php echo e($adminOnclick); ?>"
                                                class="p-2 <?php echo e($consumeClass('blue')); ?> rounded-lg transition-all border border-transparent"
                                                title="<?php echo e($adminTitle); ?>"
                                            >
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasRole('vacunador')): ?>
                                                ...
                                                <button 
                                                    type="button"
                                                    <?php if($consumeDisabled): echo 'disabled'; endif; ?>
                                                    onclick="<?php echo e($dispatchOnclick); ?>"
                                                    class="p-2 <?php echo e($consumeClass('indigo')); ?> rounded-lg transition-all border border-transparent"
                                                    title="<?php echo e($dispatchTitle); ?>"
                                                >
                                            ...
                                            <button 
                                                type="button"
                                                <?php if($consumeDisabled): echo 'disabled'; endif; ?>
                                                onclick="<?php echo e($wasteOnclick); ?>"
                                                class="p-2 <?php echo e($consumeClass('rose')); ?> rounded-lg transition-all border border-transparent"
                                                title="<?php echo e($wasteTitle); ?>"
                                            >
...
[$__name, $__params] = $__split('vaccine-chart-modal', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2326154912-0', null);
...
<?php /**PATH D:\laragon\www\vax-control\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>