    ...
    <div class="glass rounded-2xl border border-white/20 p-6 md:p-8 shadow-sm">
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['allowedDomains'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div 
        ...
        x-init="window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('saved', () => { show = true; setTimeout(() => show = false, 3000) })"
        x-show="show" 
...
<?php /**PATH D:\laragon\www\vax-control\resources\views/livewire/admin/system-settings.blade.php ENDPATH**/ ?>