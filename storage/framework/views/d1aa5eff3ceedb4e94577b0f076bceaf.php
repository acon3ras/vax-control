                ...
                <div class="bg-gradient-to-r from-slate-50 to-white px-6 py-4 border-b border-slate-100 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg leading-6 font-bold text-slate-800" id="modal-title">
                            Estadísticas: <span class="text-premium-600"><?php echo e($vaccine->name); ?></span>
                        </h3>
                        <p class="text-xs text-slate-500 mt-1 uppercase tracking-wide font-semibold"><?php echo e($vaccine->code); ?></p>
                    </div>
                                ...
                                renderChart() {
                                    ...
                                    this.chart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                data: [
                                                    <?php echo e($administeredData); ?>, 
                                                    <?php echo e($dispatchedData); ?>, 
                                                    <?php echo e($wastageData); ?>
...
<?php /**PATH D:\laragon\www\vax-control\resources\views/livewire/vaccine-chart-modal.blade.php ENDPATH**/ ?>