<div 
    x-data="{ show: <?php if ((object) ('showModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'->value()); ?>')<?php echo e('showModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'); ?>')<?php endif; ?>.live }"
    x-show="show"
            ...
            <div class="px-5 py-5">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('error')): ?>
                        <div class="mb-6 p-4 bg-rose-50 border-2 border-rose-200 rounded-2xl">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-bold text-rose-700"><?php echo e(session('error')); ?></span>
                            </div>
                        </div>
                    ...
                    <form wire:submit.prevent="process" class="space-y-4">
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($locked): ?>
                                <div class="px-4 py-3 bg-slate-50 border-2 border-slate-100 rounded-2xl flex items-center font-bold text-slate-700">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'RECEIPT'): ?> <span class="text-emerald-500 mr-2">●</span> INGRESO DE STOCK
                                    <?php elseif($type === 'ADMINISTRATION'): ?> <span class="text-blue-500 mr-2">●</span> APLICACIÓN / VACUNATORIO
                                    <?php elseif($type === 'DISPATCH'): ?> <span class="text-indigo-500 mr-2">●</span> DESPACHO EXTERNO
                                    <?php elseif($type === 'WASTAGE'): ?> <span class="text-rose-500 mr-2">●</span> MERMA / PÉRDIDA
                                    <?php elseif($type === 'QUARANTINE_MOVE'): ?> <span class="text-amber-500 mr-2">●</span> MOVER A CUARENTENA
                                    <?php elseif($type === 'QUARANTINE_RELEASE'): ?> <span class="text-emerald-500 mr-2">●</span> LIBERAR DE CUARENTENA
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php else: ?>
                                    <?php
                                    ...
                                    <button 
                                        ...
                                        class="flex items-center justify-center px-4 py-3 rounded-2xl border-2 transition-all font-bold text-sm <?php echo e($type == 'RECEIPT' ? 'bg-emerald-50 border-emerald-500 text-emerald-700 shadow-sm' : 'bg-slate-50 border-slate-100 text-slate-400 hover:border-slate-200'); ?>"
                                    >
                                    ...
                                    <button 
                                        ...
                                        class="flex items-center justify-center px-4 py-3 rounded-2xl border-2 transition-all font-bold text-sm <?php echo e($type == 'ADMINISTRATION' ? 'bg-blue-50 border-blue-500 text-blue-700 shadow-sm' : 'bg-slate-50 border-slate-100 text-slate-400 hover:border-slate-200'); ?> <?php echo e(!$hasStock ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                    >
                                    ...
                                    <button 
                                        ...
                                        <?php if(!$hasStock): ?> disabled <?php endif; ?>
                                        class="flex items-center justify-center px-4 py-3 rounded-2xl border-2 transition-all font-bold text-sm <?php echo e($type == 'WASTAGE' ? 'bg-rose-50 border-rose-500 text-rose-700 shadow-sm' : 'bg-slate-50 border-slate-100 text-slate-400 hover:border-slate-200'); ?> <?php echo e(!$hasStock ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                    >
                                    ...
                                    <button 
                                        ...
                                        <?php if(!$hasStock): ?> disabled <?php endif; ?>
                                        class="flex items-center justify-center px-4 py-3 rounded-2xl border-2 transition-all font-bold text-sm <?php echo e($type == 'DISPATCH' ? 'bg-amber-50 border-amber-500 text-amber-700 shadow-sm' : 'bg-slate-50 border-slate-100 text-slate-400 hover:border-slate-200'); ?> <?php echo e(!$hasStock ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                    >
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($locked && $vaccine_id): ?>
                                <div class="block w-full px-4 py-3 bg-slate-50 border-2 border-slate-100 rounded-2xl font-bold text-slate-700 flex justify-between items-center">
                                    <span><?php echo e($vaccines->find($vaccine_id)->name ?? 'Vacuna Desconocida'); ?></span>
                                    <span class="text-xs font-mono bg-slate-200 text-slate-500 px-2 py-1 rounded-md"><?php echo e($vaccines->find($vaccine_id)->code ?? ''); ?></span>
                                </div>
                            ...
                            <?php else: ?>
                                <select wire:model="vaccine_id" class="block w-full px-4 py-3 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-premium-500/10 focus:border-premium-500 transition-all font-bold text-slate-700">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $vaccines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($v->id); ?>"><?php echo e($v->name); ?> (<?php echo e($v->code); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['vaccine_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-rose-500 font-bold mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="mb-4 bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($vaccine_id): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type, ['QUARANTINE_MOVE', 'QUARANTINE_RELEASE'])): ?>
                                        <div class="grid grid-cols-2 gap-4">
                                            <!-- Available Stock -->
                                            <div class="text-center p-2 rounded-lg <?php echo e($type === 'QUARANTINE_MOVE' ? 'bg-emerald-50 border border-emerald-100' : 'bg-slate-50'); ?>">
                                                <span class="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">Disponible</span>
                                                <span class="block text-xl font-black <?php echo e($type === 'QUARANTINE_MOVE' ? 'text-emerald-600' : 'text-slate-600'); ?>">
                                                    <?php echo e($this->availableStock); ?>

                                                </span>
                                            </div>
                                            <!-- Quarantine Stock -->
                                            <div class="text-center p-2 rounded-lg <?php echo e($type === 'QUARANTINE_RELEASE' ? 'bg-amber-50 border border-amber-100' : 'bg-slate-50'); ?>">
                                                <span class="block text-[10px] uppercase font-bold text-slate-400 tracking-wider">En Cuarentena</span>
                                                <span class="block text-xl font-black <?php echo e($type === 'QUARANTINE_RELEASE' ? 'text-amber-600' : 'text-slate-600'); ?>">
                                                    <?php echo e($this->quarantineStock); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'DISPATCH'): ?>
                            <div>
                                ...
                                <select wire:model="destination_id" class="block w-full px-4 py-3 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-premium-500/10 focus:border-premium-500 transition-all font-bold text-slate-700">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $externalLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($loc->id); ?>"><?php echo e($loc->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </select>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['destination_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-rose-500 font-bold mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'WASTAGE'): ?>
                            <div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'QUARANTINE_MOVE'): ?>
                            <div>
                                ...
                                <select wire:model.live="reason" class="block w-full px-4 py-3 bg-slate-50 border-2 <?php echo e($errors->has('reason') ? 'border-rose-500' : 'border-slate-100'); ?> rounded-2xl focus:ring-4 focus:ring-premium-500/10 focus:border-premium-500 transition-all font-bold text-slate-700">
                                    <option value="">Seleccione el motivo...</option>
                                    <option value="Pérdida de Cadena de Frío">Pérdida de Cadena de Frío</option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea wire:model="notes" rows="2" class="block w-full px-4 py-3 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:ring-4 focus:ring-premium-500/10 focus:border-premium-500 transition-all font-medium text-slate-600 text-sm" placeholder="<?php echo e($this->notesPlaceholder); ?>"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($evidence): ?>
                                <div class="mt-2 text-xs font-bold text-emerald-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                                    Archivo seleccionado: <?php echo e($evidence->getClientOriginalName()); ?>

                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['evidence'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-rose-500 font-bold mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH D:\laragon\www\vax-control\resources\views/livewire/inventory-adjuster.blade.php ENDPATH**/ ?>